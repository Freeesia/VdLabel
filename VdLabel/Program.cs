...
builder.Services
    ...
    .AddSingleton<ICommandService>(sp => sp.GetRequiredService<CommandLabelService>())
    .AddSingleton(sp => new Lazy<ICommandService>(() => sp.GetRequiredService<ICommandService>()))
